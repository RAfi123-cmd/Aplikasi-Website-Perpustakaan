...
import { IconCalendar, IconCalendarMonth, IconCalendarWeek, IconChartDots2, IconCreditCardPay, IconEye, IconMoneybag } from "@tabler/icons-react"
...
export default function Index(props) {
    ...
    return (
        <div className="flex flex-col w-full pb-32 space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
                <CardStat
                    data={{ 
                        title: 'Harian',
                        icon: IconCalendar,
                        backgroud: 'text-white bg-gradient-to-r from-blue-400 via-blue-500 to-blue-500',
                ...
                <CardStat
                    data={{ 
                        ...
                        backgroud: 'text-white bg-gradient-to-r from-purple-400 via-purple-500 to-purple-500',
                        iconClassName: 'text-white',
                     }}
                >
                ...
                <CardStat
                    data={{ 
                        ...
                        backgroud: 'text-white bg-gradient-to-r from-rose-400 via-rose-500 to-rose-500',
                        iconClassName: 'text-white',
                     }}
                >
                ...
                <CardStat
                    data={{ 
                        title: 'Tahunan',
                        icon: IconCalendar,
                        backgroud: 'text-white bg-gradient-to-r from-lime-400 via-lime-500 to-lime-500',
                        iconClassName: 'text-white',
                     }}
                >
            ...
            <h2 className="font-semibold leading-relaxed text-foreground">Denda Bedasarkan Member</h2>

            <div className="grid gap-4 md:gap-8 lg:grid-cols-2">
                <Card>
                    <CardHeader>
                        <CardTitle>Member Yang Dimiliki Denda Paling Banyak</CardTitle>
                    </CardHeader>
                    <CardContent className="px-0 py-0 [&_td]:whitespace-nowrap [&_td]:px-6 [&_th]:px-6">
                        <Table className="w-full">
                            <TableHeader>
                ...
                <div className="grid gap-4 md:gap-8 lg:grid-cols-1">
                    ...
                    <CardStatDescription title="Belum Dibayar" description="Denda yang belum di bayar">
                        <div className="flex items-baseline gap-2 text-3xl font-bold tabular-nums leading-none text-orange-500">
