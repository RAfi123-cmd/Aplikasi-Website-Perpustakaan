...
import { IconArrowLeft, IconBooks, IconCategory } from "@tabler/icons-react"
            ...
            <Card>
                <CardContent className="p-6">
                    <form className="space-y-6" onSubmit={onHandleSubmit}>
                        ...
                        <div className="grid w-full items-center gap-1.5">
                            <Label htmlFor="isbn">ISBN (Internasional Standard Book Nasional)</Label>
                            <Input
                                name="isbn"
                                id="isbn"
                                type="text"
                        ...
                        <div className="grid w-full items-center gap-1.5">
                            ...
                            {errors.number_of_pages && (
                                <InputError message={errors.number_of_pages}/>
                            )}
                        </div>
