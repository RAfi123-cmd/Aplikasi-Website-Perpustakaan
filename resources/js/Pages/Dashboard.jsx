            ...
            {auth.role.some((role) => ['admin', 'operator'].includes(role)) && (
                ...
                <CardStat
                    data={{ 
                        title: 'Total Buku',
                        icon: IconBooks,
                        background: 'text-white bg-gradient-to-r from-blue-400 via-blue-400 to-blue-500',
                ...
                <CardStat
                    data={{ 
                        ...
                        icon: IconUsersGroup,
                        background: 'text-white bg-gradient-to-r from-purple-400 via-purple-400 to-purple-500',
                        iconClassName: 'text-white',
                     }}
                >
                ...
                <CardStat
                    data={{ 
                        ...
                        background: 'text-white bg-gradient-to-r from-rose-400 via-rose-400 to-rose-500',
                        iconClassName: 'text-white',
                     }}
                >
                ...
                <CardStat
                    data={{ 
                        ...
                        background: 'text-white bg-gradient-to-r from-lime-400 via-lime-400 to-lime-500',
                        iconClassName: 'text-white',
                     }}
                >
                        ...
                        <Table className='w-full'>
                            ...
                            <TableBody>
                                {props.page_data.return_books.map((return_bok, index) => (
                                    <TableRow key={index}>
                                        <TableCell>{index + 1}</TableCell>
                                        <TableCell>{return_bok.return_book_code}</TableCell>
                                        <TableCell>{return_bok.book.title}</TableCell>
                                        <TableCell>{return_bok.user.name}</TableCell>
                                    </TableRow>
                                ))}
                            </TableBody>
                        </Table>
